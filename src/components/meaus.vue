    ...
    <keep-alive>
        <el-tabs v-model="activeName" @tab-click="handleClick" id='el-tabs'>
            <el-tab-pane class='grid-content' :span="12" label="热播列表" name="first" id="container" font='20'>
                <mt-button v-if='showBtn == 1' type="danger" @click='incress' style='width: 95%;height: 50px;'>
                    浏览量加1(子传父)
                </mt-button>
                <mt-button v-else-if='showBtn == 2' type="danger" size='small' @click='incress'
                           style='width: 85%;height: 50px;'>浏览量加2(子传父){{setDate.time}}
                </mt-button>

                <mt-button v-else='showBtn == 3' size='small' type="danger" @click='incress'
                           style='width: 85%;height: 50px;'>浏览量加3(子传父)
                </mt-button>
                ...
                <!-- <p>{{count}}</p> -->
                <p>{{stateObj}}</p>
                <mt-button size='small' @click='increase' type="primary" style='width: 50%;height: 50px;'>数字加
                </mt-button>
